...
export const typeDefs = gql`
  ...
  type Mutation {
    ...
    createMatch(team1: ID!, team2: ID!, goals_team1: Int!, goals_team2: Int!, date: String!, status: MatchStatus!, token: String!): Match!
    updateMatch(id: ID!, goals_team1: Int!, goals_team2: Int!, status: MatchStatus!, token: String!): Match!
    deleteMatch(id: ID!, token: String!): Match!
    createPlayer(name: String, token: String!): Player!
    deletePlayer(id: ID!, token: String!): Player!
    createUser(mail: String!, password: String!, token: String!): User!

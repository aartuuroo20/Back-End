...
import { EquipoSchema, PartidoSchema } from "../../../APIGestionMundial/src/db/schema.ts";
...
export const equiposCollection = db.collection<EquipoSchema>("equipos");
export const partidosCollection = db.collection<PartidoSchema>("partidos");
...
import { CocheSchema, ConcecionarioSchema, VendedorSchema } from "./schema.ts";
...
export const concecionarioCollection = db.collection<ConcecionarioSchema>("Concecionarios");
